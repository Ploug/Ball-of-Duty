...
public class Vector2 
{
    ...
    /**
     * Gets the angle of the vector in degrees. For example 90 would mean the vector is pointing NORTH, and 0 would mean the vector is pointing EAST.
     * @return The angle of the vector in degrees. For example 90 would mean the vector is pointing NORTH, and 0 would mean the vector is pointing EAST.
     */
